...
pub struct FieldDefinition {
    ...
    pub default_override: Option<json::Value>,
...
pub struct TilesetDefinition {
    ...
    pub cached_pixel_data: Option<HashMap<String, Option<json::Value>>>,
    ...
    pub saved_selections: Vec<HashMap<String, Option<json::Value>>>,
...
pub struct FieldInstance {
    ...
    pub real_editor_values: Vec<Option<json::Value>>,
}
